using DesignPatterns.Infra.Data.Sql.Commands.Common;
using DesignPatterns.Infra.Data.Sql.Queries.Common;
...
namespace DesignPatterns.Endpoints.API.Extentions
{
    public static class HostingExtensions
    {
        public static WebApplication ConfigureServices(this WebApplicationBuilder builder)
        {
            ...
            //zamin
            builder.Services.AddZaminApiCore("Zamin", "DesignPatterns");
            ...
            //CommandDbContext
            builder.Services.AddDbContext<DbContextDesignPatternsCommandDbContext>(c => c.UseSqlServer(configuration.GetConnectionString("CommandDb_ConnectionString"))
                .AddInterceptors(new SetPersianYeKeInterceptor(), new AddAuditDataInterceptor()));

            //QueryDbContext
            builder.Services.AddDbContext<DbContextDesignPatternsQueryDbContext>(c => c.UseSqlServer(configuration.GetConnectionString("QueryDb_ConnectionString")));
